...
\usepackage{lipsum}%some one on stackexchange said thiswould let me change column #
...
\background{%
	\begin{tikzpicture}
	[remember picture,overlay]\node[opacity=1] at (current page.center) {\includegraphics[width=\paperwidth,height=\paperheight]{nsclposter.pdf}};
	\end{tikzpicture}%
}
...
%----------------------------------------------------------------------------------------
%
{\includegraphics[height=5em]{nscl.png}} % First university/lab logo on the left
{\bf\textsc{The Most Pragmatic Information Ever}\vspace{0.5em}} % Poster title
{\textsc{Michael Roosa -  \hspace{12pt} Michigan State University \\ Department of Physics \& Astronomy}} % Author names and institution
{\includegraphics[height=5em]{msublk.png}} % Second university/lab logo on the right
...
\headerbox{Conclusion And Addendum }{name=bottommiddle,column=1,span=2,above=bottom}{ 
